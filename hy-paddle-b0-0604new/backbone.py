...
class HybridNetsBackbone(nn.Layer):
    def __init__(self, num_classes=80, compound_coef=0, seg_classes=1, backbone_name=None, seg_mode=MULTICLASS_MODE, onnx_export=False, use_pretrain=False, **kwargs):
        ...
        # 新增
        self.segp2_input_channels = [24, 0, 0, 0, 0, 0, 0, 0, 0]
        ...
        if use_pretrain:
            self.init_backbone(path = 'weights\efficientdet-d0-pretrained.pdparams')
