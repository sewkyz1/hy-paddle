...
def get_args():
    ...
    parser.add_argument('--freeze_det', type=boolean_string, default=True,
    ...
    parser.add_argument('-w', '--load_weights', type=str, default='D:\\deeplearning\\HybridNets-paddle-main\\new-b0-0604\\hy-paddle-b0-0604new\\checkpoints\\bdd100k\\hybridnets-d0_37_8750.pdparams',
            ...
            if is_train:
                ...
                for data in training_generator:
                    ...
                    try:
                        ...
                        # 测试用
                        # regression, classification, anchors, segmentation = model(imgs, annot,
                        #                                                             seg_annot,
                        #                                                             obj_list=params.obj_list)                        
                        # 第二次测试以上
